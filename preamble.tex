...
\forestset{
  numbered/.style={
    for tree={
      ...
      % },
      delay={
        % root (n=0): take start label
        if n=0{
          this label/.expanded=\forestoption{start label},
          content={\forestoption{this label}\\\hline ##1},
          % pass this label to children through their parent label option
          for children={
            parent label/.option=!u.this label
          },
        }{
          % non-root: build text label from parent's parent label (set earlier) + .n
          this label/.expanded=\forestoption{parent label}.\forestoption{n},
          % this label=\forestoption{parent label},
          content={\forestoption{this label}\\\hline ##1},
          for children={
            parent label/.option=!u.this label
          },
  ...
  declare count={mycount}{1},
  declare toks={this label}{defaultThis},
  declare toks={parent label}{defaultParent} ,
  declare toks={start label}{1} , % default start label
}
